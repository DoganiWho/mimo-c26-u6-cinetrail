  ...
  return ( 
        <div key={review.id}  className="review"> 
            <div className="avatar-container">
                <img className="avatar" src={imageError ? 'https://freesvg.org/img/abstract-user-flat-4.png' : `https://image.tmdb.org/t/p/w500/${review.author_details.avatar_path}`} alt="avatar"
